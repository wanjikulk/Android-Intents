...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout mBtn;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout mBtn,
      @NonNull Button mBtnCall, @NonNull Button mBtnCamera, @NonNull Button mBtnEmail,
      @NonNull Button mBtnMap, @NonNull Button mBtnMpesa, @NonNull Button mBtnShare,
      @NonNull Button mBtnSms, @NonNull Button mBtnWebsite) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      ConstraintLayout mBtn = (ConstraintLayout) rootView;
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, mBtn, mBtnCall, mBtnCamera,
          mBtnEmail, mBtnMap, mBtnMpesa, mBtnShare, mBtnSms, mBtnWebsite);
    }
